...
import 'package:frontend/screens/nav/tickets/adminAllTicketBox.dart';
import 'package:frontend/screens/nav/tickets/allticketbox.dart';


class AdminAllTickets extends StatelessWidget {
  const AdminAllTickets ({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              AText(
                text: "Here's an overview of tickets raised by clients.",
              ...
              AText(
                text: "Tickets Raised By Clients",
                fontWeight: FontWeight.w700,
                size: 15,
                color: Colors.grey[900],
              ),
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AdminSingleProject(projectId: index+1,)));
                  },
                  child: AdminAllTicketBox(
